...
//                            noNewNotification.visibility= View.INVISIBLE
    ...
    fun showIndicatorPropertiesDialog(indicator:String){
        var dialog: ShowIndicatorPropertiesDialog? = null
        dialog = ShowIndicatorPropertiesDialog(showDialogCounter,indicator,null,object :
    ...
    fun initPage(){
        try {
            strategylist.clear()
            strategylist.addAll(MyStrategy.getMExitCondition())
            viewAdapter.notifyDataSetChanged()
        }catch (e:Exception){
            e.printStackTrace()
        }
    ...
    fun setPage(){
        try {
            MyStrategy.setMExitCondition(strategylist)
        }catch (e:Exception){
            e.printStackTrace()
        }
    }
